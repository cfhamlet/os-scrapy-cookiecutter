...
def valid_project_name(project_name):
    ...
    if not re.search(r'^[_a-zA-Z]\w*$', project_name):
        LogError('Project names must begin with a letter and contain'
...
def startproject(project_name, project_dir, cwd="."):
    ...
    try:
        proc = subprocess.Popen(['scrapy', 'startproject', project_name, project_dir], shell=run_thru_shell, cwd=cwd)
